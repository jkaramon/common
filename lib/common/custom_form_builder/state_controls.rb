          ...
          memo += template.content_tag(:button, localized_event_name, { 
            ...
            'data-event_header' => 
              ::I18n.t("activemodel.state_events.#{class_name}.headers.#{event_name}", 
                :default => [ ::I18n.t("activemodel.state_events.#{parent_class_name}.headers.#{event_name}"), localized_event_name ]),
            'data-event_description' => 
              ::I18n.t("activemodel.state_events.#{class_name}.descriptions.#{event_name}", 
                :default => [ ::I18n.t("activemodel.state_events.#{parent_class_name}.descriptions.#{event_name}"), localized_event_name ]),
